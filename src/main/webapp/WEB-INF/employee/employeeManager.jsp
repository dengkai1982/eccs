...
<div class="edu_content">
    <div class="oper_panel base-border main_panel_bg">
        ...
        <div class="actions">
            <div class="btn-group">
                <a href="${contextPath}/employee/employeeManager/new${suffix}?${paginationCurrentPage}=1" class="btn btn-link"  style="margin-left: 10px;"><i class="icon icon-plus"></i> 新增员工</a>
                <%-- id="showSearch" 不能修改 --%>
                ...
                remoteConverter:function(result){
                    ...
                    $.each(pagination.data,function(i,d){
                        var editor=getTemplateHtml("operAction",{
                            href:"${contextPath}/employee/employeeManager/modify${suffix}?id="+d.id+
